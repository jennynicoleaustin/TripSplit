...
//    }
//
//// Create a function that accepts any type to return any list of members
...
// add in to lowercase so format of name does not matter
//  create error handling for if member does not exist
...
//    public static Expense addExpense(String name, int total, TripGroup group, String... memberName, GroupMember paidBy) {
